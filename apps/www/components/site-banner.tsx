...
function trackBannerClick(eventName: string) {
  ...
  const posthog = (
    window as Window & {
      posthog?: { capture?: (name: string) => void };
    }
  ).posthog;
    ...
    <div className="group relative top-0 bg-indigo-600 py-3 text-white transition-all duration-300 md:py-0">
      <div className="container flex flex-col items-center justify-center gap-4 md:h-12 md:flex-row">
        <Link
          ...
          onClick={() => trackBannerClick('banner_cta_clicked')}
          target="_blank"
    ...
    <div className="group relative top-0 bg-[#ff6154] py-3 text-white transition-all duration-300 md:py-0">
      <div className="container flex flex-col items-center justify-center gap-4 md:h-12 md:flex-row">
        <Link
          ...
          onClick={() => trackBannerClick('product_hunt_banner_clicked')}
          target="_blank"
          className="inline-flex text-xs leading-normal md:text-sm"
        >
          ✨
