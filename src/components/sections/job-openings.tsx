...
type FascinanteJobOpeningsProps = {
  overline?: string;
  title?: string;
  intro?: string;
  notifyText?: string;
...
export default function FascinanteJobOpenings({
  overline = 'Jobs',
  title = 'Jobs Opening',
  ...
  jobs = DEFAULT_JOBS,
}: FascinanteJobOpeningsProps) {
  return (
    <section id="fascinante-job-openings" className="bg-background px-6 lg:px-0">
