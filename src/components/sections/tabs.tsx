...
export type FascinanteFeaturesTabsProps = {
  tagline?: string;
  title?: string;
  description?: string;
  items?: FeatureItem[];
...
const DEFAULT_ITEMS: FeatureItem[] = [
  ...
  },
  {
    key: 'integrations',
    label: 'Integrations',
    body: 'Connect Fascinante to your stack with webhooks and SDKs. Sync events from billing to your CRM, data warehouse, and analytics tools.',
    imageSrc: '/images/features/Frame.webp',
...
export default function FascinanteFeaturesTabs({
    ...
    >
      <div className="container px-0 py-16 sm:py-20 md:px-6 md:py-24">
        <div className="max-w-3xl">
          ...
          <h2 className="text-foreground text-h2 mt-4 font-semibold tracking-tighter">
            {title}
          </h2>
